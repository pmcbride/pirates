...
reward icons (a recruit's portrait face when the voyage brings a new mate),
and a big "Set Sail" CTA. Routes drawer becomes a "Voyage Log" drawer listing
cleared missions with stars and Captain's Log entries.
